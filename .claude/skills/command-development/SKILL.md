...
*Nguồn: [Anthropic](https://github.com/anthropics/claude-plugins-official) - `claude-plugins-official/plugins/plugin-dev/skills/command-development` - giấy phép Apache-2.0.*
