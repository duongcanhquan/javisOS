---
name: "design-md"
description: "Soạn/kiểm/xuất file token DESIGN.md theo chuẩn Google."
description_en: "Author/validate/export Google's DESIGN.md token spec files."
...
*Nguồn: [Nous Research](https://github.com/NousResearch/hermes-agent) - `hermes-agent/skills/creative/design-md` - giấy phép MIT.*
*Đã sửa để chạy trên Javis OS: `group` được thêm cho trang Kỹ năng của Javis. Nội dung skill giữ nguyên bản gốc.*
