...
description: "UI frontend có chủ đích: palette, typography, layout — tránh mặc định kiểu AI."
description_en: "Distinctive frontend UI: intentional palette, typography, and layout - avoid templated AI defaults."
group: Marketing
license: Complete terms in LICENSE.txt
---

# Hỗ trợ Frontend Design Skill (frontend-design)

## Cổng liên kết (bắt buộc)

- **Trước khi** viết HTML/CSS/React sản phẩm: nếu ý tưởng chưa được duyệt thiết kế, nạp skill **`brainstorming`** (Spike/Bounded/Architectural) và chờ user Say Yes.
