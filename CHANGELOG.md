...
- **Kho Drive · Chưng cất:** nút **Chưng cất kho** + file sync mang `status: unprocessed`. Bảo đọc hết/chưng cất thì Javis ingest lần lượt (không còn từ chối «không mass-ingest»). PDF chưa ra chữ thì báo rõ.
...
## [0.55.170] - 2026-09-09
### Cải tiến
- **Tạo video dễ nhìn hơn:** tab rõ nghĩa (Promo / Có lời đọc / Collage…), form chia mục, giữ nội dung khi đổi tab, nút Tạo video nổi, bớt jargon.
...
## [0.55.149] - 2026-09-08
### Sửa lỗi
- **Nút LLM OpenMAIC:** đổi tên «Lưu LLM», không còn báo lỗi mơ hồ khi thiếu Docker; sync gắn `docker.sock` + `DOCKER_GID` vào Javis để lần sau lưu là đổi được model.

## [0.55.148] - 2026-09-08
### Sửa lỗi
- **Chọn OpenAI mà OpenMAIC vẫn gọi Gemini:** sửa nút Áp dụng (Docker API); sync đã đặt `openai:gpt-4o-mini`. UI báo rõ khi chưa đồng bộ với container.

## [0.55.147] - 2026-09-08
### Cải tiến
- **OpenMAIC tự chọn LLM trong Bài giảng:** Gemini / OpenAI / DeepSeek (key lấy từ Models), bấm Áp dụng — không cần sửa code deploy.

## [0.55.146] - 2026-09-08
### Sửa lỗi
- **OpenMAIC «không thấy file» khi thiếu tiền tố slug:** ví dụ `marketing-thuc-chien` tự khớp `digital-marketing-thuc-chien`; ô path cũng nhận gợi ý khi vẫn 404.
...
## [0.55.121] - 2026-09-07
### Cải tiến
- **Marketing → Ads FB:** báo cáo Meta Ads đủ số đo (spend, reach, CTR, CPC, CPM, chuyển đổi) + bảng chiến dịch + diễn giải dễ hiểu; tách riêng tab Page FB.
...
### Cải tiến
- **Chuỗi nghiên cứu & KD/MKT dùng Gemini Pro:** agent nghiên cứu/proposal/kế hoạch/kiểm chứng gắn `gemini-3.1-pro-preview`; xuất gói và đồ họa dùng `gemini-3.6-flash` (nhanh, rẻ hơn). Seed lại caps trên VPS là ăn.

## [0.55.68] - 2026-09-06
### Sửa
- **Deploy VPS hết xếp hàng chung với seed/pull-brains:** nhóm concurrency riêng `vps-deploy`, deploy mới huỷ deploy cũ thay vì chờ 5–7 phút.
- **Hot path chỉ pull image + up + health:** bỏ seed brief, optimize/prune và kiểm tra health lần 2 mỗi lần đẩy; không fetch git trùng khi workflow đã reset.

## [0.55.67] - 2026-09-06
### Sửa
- **Chuỗi nghiên cứu → kế hoạch KD/MKT:** đồng bộ skill vào cả hai brain; xuất gói nhận đủ `01`–`09`; workflow nhắc bước tiếp theo; agent kiểm chứng/xuất/vận hành gắn đúng skill.

## [0.55.66] - 2026-09-06
### Cải tiến
- **Quy trình KD & Marketing từ nghiên cứu:** sau nghiên cứu thị trường có workflow chuẩn tài chính → kế hoạch kinh doanh → kế hoạch marketing → playbook vận hành (đồng bộ mọi brain).
- **Bốn skill mới:** `phan-tich-tai-chinh-mkt`, `ke-hoach-kinh-doanh`, `ke-hoach-marketing`, `quy-trinh-van-hanh-kd-mkt`.

## [0.55.65] - 2026-09-06
### Cải tiến
- **Deploy VPS nhanh hơn:** mỗi lần đẩy code chỉ pull image và khởi động lại; seed hồ sơ / antigravity / learn chạy tay khi cần.
- **Studio:** form nhập brief workflow (mục tiêu, phạm vi, ràng buộc) thay hộp thoại một dòng.
- **Telegram & Zalo:** gõ `/run <workflow>` hoặc `/tên-skill` để chạy; báo tiến trình và duyệt khi cần.
- **Seed caps:** cùng gói workflow/skill chuẩn vào mọi brain trên VPS.

## [0.55.64] - 2026-09-06
### Cải tiến
- **Skill brainstorming + writing-plans:** thiết kế Spike/Bounded/Architectural có hard-gate; proposal/nghiên cứu thị trường nối nhau; seed workflow lên Brain Default và School of Art trên VPS.

## [0.55.63] - 2026-09-06
### Cải tiến
- **Skill Nghiên cứu thị trường chuyên sâu:** thêm khung JTBD, STEEPLE/pháp lý, văn hóa vùng miền, TAM/SAM/SOM đối chiếu chéo và checklist kiểm chứng trước khi viết proposal.
