...
## [0.35.50] - 2026-09-05
### Sửa lỗi
- **Nhắc hẹn hết báo oan "Claude CLI chưa cài" khi việc nền là Ollama Local.** Không còn coi máy chưa cài Claude là "sẵn sàng" rồi fallback chết; Telegram báo đúng lý do (thiếu endpoint/model) và nhắc chọn Ollama ở Models.
