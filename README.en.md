...
|---|---|---|
| Brain | Hard-wired to one model, one stateless API call per message | **Swappable**: 13 providers, each with the full set of tools, MCP, skills and sessions - including models running on your own machine through Ollama Local (fork) |
