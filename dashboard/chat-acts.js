/* chat-acts.js - hang nut duoi moi tin nhan trong khung chat VMOS.

   Moi bong bong co mot hang nho ben duoi. Tin cua NGUOI DUNG: gio gui, gui lai, sua lai,
   sao chep. Tin cua VMOS: chi gio gui + sao chep. Hang nay AN san (opacity 0), chi hien khi
...
(function () {
  ...
  // role: "user" | "javis".
  //
  // Tin cua VMOS chi con gio + sao chep. Nut "Tra loi lai cau hoi phia tren" da BO
  // (chu repo yeu cau 01/09): no nam ngay canh nut sao chep, ma sao chep la thao tac
  // hay dung nhat duoi mot cau tra loi - bam truot mot ly la VMOS chay lai ca luot,
