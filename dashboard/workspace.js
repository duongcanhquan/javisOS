...
(function () {
    ...
    el.innerHTML =
      '<div class="wspage" id="wsPage">' +
        '<aside class="ws-left" id="wsLeft">' +
          ...
          '<button type="button" class="ws-btn" id="wsStore">' + ic("package") + ' VMOS Store</button></div>' +
        '</aside>' +
        '<div class="ws-main">' +
          '<div class="ws-bar">' +
  ...
  // Khung chat là node MƯỢN của app: trang Cộng sự, trang Trò chuyện và màn VMOS dùng CHUNG
