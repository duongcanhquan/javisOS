...
| Cuộc họp: nói gần mic ra chữ, họp online qua loa thì không | Trang Cuộc họp: tick **Ghi tiếng máy**, Bắt đầu → chọn tab họp hoặc Toàn màn hình + «Chia sẻ âm thanh». Không chia sẻ thì mic bắt loa analog (đã tắt AEC). **Ctrl+Shift+R** nếu chưa thấy ô tick. |
