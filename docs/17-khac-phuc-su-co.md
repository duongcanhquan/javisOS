...
| Cuộc họp: nói gần mic ra chữ, họp online qua loa thì không | Mic cuộc họp không chống vọng nên vẫn bắt loa analog. Tick **Ghi tiếng máy**, Bắt đầu, chọn tab họp hoặc Toàn màn hình + «Chia sẻ âm thanh» để mix thêm tiếng số. **Ctrl+Shift+R** nếu chưa thấy ô tick. |
