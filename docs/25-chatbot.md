...
Hai mức nâng quyền cần engine gọi được công cụ. Bảy engine API (OpenRouter, OpenAI, Anthropic, Gemini, Groq, DeepSeek, Ollama) và gói Claude Code dùng đường đã chạy thật lâu nay. Riêng **gói ChatGPT** đi qua một đường của backend Codex mà nhà cung cấp chưa công bố ổn định, nên có thể không gọi được công cụ.
