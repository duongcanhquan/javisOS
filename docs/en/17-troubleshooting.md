...
| Meeting: close-mic works, online audio from speakers does not | Tick **Capture computer audio**, Start. Zoom/Teams app: **Entire screen** + **Share audio** (do not pick the Zoom window). Meet in Chrome: the meeting tab + share audio. **Ctrl+Shift+R** if you do not see the checkbox. |
