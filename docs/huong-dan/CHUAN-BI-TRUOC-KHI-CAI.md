...
6. Nếu Windows chặn `.bat`: *More info → Run anyway*. Không cài Python từ Microsoft Store.
...
6. File `.command` tải ZIP bị Gatekeeper: mở Terminal, gõ `bash ` (có dấu cách), kéo `1-Cai-dat.command` thả vào, Enter.
