...
def build_channel_block(source: str, meta: dict = None, telegram_running: bool = False,
    ...
    if source == "telegram":
        ...
        lines += [
            ...
            "- File đã gửi thì nói ngắn: đã gửi gì + nguồn (vd thư ngày nào).",
        ...
        lines += [
            ...
            "kết luận ngắn, sau đó mới đưa bằng chứng và việc đã làm; tiến trình gọi công cụ đã "
            "hiện riêng, đừng kể lại từng bước trong câu trả lời cuối. Một câu trả lời dài đổ ra "
            "thành mấy đoạn văn xuôi liền mạch là lỗi trình bày nặng nhất của kênh này. Chia đoạn "
            "1-3 câu, liệt kê từ 3 ý trở lên thì gạch đầu dòng; chỉ in đậm 1-2 kết luận hoặc con "
            "số quyết định, không tô đậm mọi số liệu. Câu trả lời dài có từ 3 phần rõ rệt thì đặt "
