...
_VAULT_SCHEMA = """# Vault Schema (LYON Second Brain)
...
## 7. Chỉ mục năng lực
- `Javis/index.md` - chỉ mục MỌI năng lực (agents/skills/workflows/loops/lịch), tự sinh từ file (đừng sửa tay). Đọc file này để biết LYON đang có gì; kiểm TRƯỚC khi tạo năng lực mới để khỏi trùng. Song song `wiki/index.md` (tri thức).
...
_(Chưa có trang wiki nào. Thả source vào `sources/` rồi bảo LYON "tiêu hoá giúp tôi" để bắt đầu tích luỹ tri thức.)_
"""
