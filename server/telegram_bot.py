...
BOT_COMMANDS = [
    ...
    {"command": "workflows", "description": "Liệt kê workflow (bấm nút để chạy)"},
    {"command": "run", "description": "Chạy workflow: /run <slug> [brief]"},
    {"command": "duyet", "description": "Duyệt bước workflow đang chờ"},
    {"command": "huy", "description": "Huỷ duyệt bước workflow"},
    ...
    {"command": "stop", "description": "Dừng câu đang trả lời / workflow"},
